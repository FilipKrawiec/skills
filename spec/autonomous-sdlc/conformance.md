...
This document supplies implementation-neutral scenarios for the [Autonomous SDLC Specification](SPECIFICATION.md). A Conforming Host MUST preserve their outcome and event ordering.
