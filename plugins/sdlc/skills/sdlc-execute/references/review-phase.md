...
4. Produce a `ReviewDecision` containing:
   * **decision**: Exactly one of `CORRECT_PLAN`, `CORRECT_EXECUTE`, or `READY_FOR_SHIP`.
   * **findings**: Detailed observations, test results, or feedback justifying the decision.
