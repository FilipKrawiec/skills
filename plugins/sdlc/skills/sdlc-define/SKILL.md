...
Produce the `Definition` as a Markdown file with YAML frontmatter. Save it to `.sdlc/tasks/<task-id>/task.md` (and copy/symlink it as a host-scoped artifact if requested by the host).
