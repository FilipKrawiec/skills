...
| `workflow-friction` | Delivery phase handoff, worktree isolation, branching, or project board synchronization encountered friction. | Adjust lifecycle stage definitions in `orchestrate-delivery` or `github-pipeline-integration.md`. |
...
### 1. Target Skill / Rule
- **Component**: `plugins/common/orchestration/skills/<skill-name>`
