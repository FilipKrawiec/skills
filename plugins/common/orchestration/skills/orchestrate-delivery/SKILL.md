...
1. **DEFINE** — Capture business outcomes, scope, non-goals, constraints, and decision owner. Record initial requirements in `implementation_plan.md`. Ask the user only about material ambiguity.
