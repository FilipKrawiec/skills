...
This reference documents the integration of GitHub Issues, GitHub Projects V2, and GitHub Pull Requests into the `deliver` workflow as the primary source of truth for features, stories, tasks, bugs, board tracking, and review automation.
...
All issues managed by the sdlc plugin use a unified label schema:
