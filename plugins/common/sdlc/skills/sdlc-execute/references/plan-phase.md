...
2. Produce an `ImplementationPlan` with YAML frontmatter containing `slices`, `boundaries`, `verification_plan`, and `recovery_controls`, then detail those values in Markdown sections. The work product should contain:
