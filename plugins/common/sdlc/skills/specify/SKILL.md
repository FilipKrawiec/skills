...
The **specify** skill takes an existing GitHub Issue on the **Backlog** and conducts interactive grilling sessions (`grill-with-context`) to refine its scope, clarify edge cases, validate acceptance criteria against repository context, and update the tracker item.
