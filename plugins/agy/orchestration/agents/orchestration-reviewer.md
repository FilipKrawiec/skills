...
- **Skills**: `ddd`, `hexagonal-architecture`, `tdd`, `vcs`, `grill-with-docs`
...
Actively invoke and enforce the enabled skills (`ddd`, `hexagonal-architecture`, `grill-with-docs`, `tdd`, and `vcs`):
